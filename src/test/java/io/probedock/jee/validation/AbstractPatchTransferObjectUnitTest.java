 ...
 */
@ProbeTestClass(tags = {"validation", "abstractPatchTransferObject"})
public class AbstractPatchTransferObjectUnitTest {

	@Test
	@ProbeTest(key = "c27716a6f309")
