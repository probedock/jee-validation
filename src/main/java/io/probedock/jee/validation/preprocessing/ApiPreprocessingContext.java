...
import io.probedock.jee.validation.AbstractPatchTransferObject;
import io.probedock.jee.validation.AbstractValidator;
...
public class ApiPreprocessingContext implements IPreprocessingConfig {
	...
	/**
	 * Adds the specified state object to the validation context.
	 *
	 ...
	 * identified by its concrete class (retrieved with <tt>getClass</tt>).
	 * 
