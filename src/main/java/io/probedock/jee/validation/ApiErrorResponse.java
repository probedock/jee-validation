 ...
 *
 * <p>This object implements {@link IErrorCollector} and can therefore be used with
 * to automatically set the HTTP status code and body of the response.</p>
 *
...
public class ApiErrorResponse implements IErrorCollector {
	...
	/**
	 * Constructs an empty error response with no error message.
	 *
